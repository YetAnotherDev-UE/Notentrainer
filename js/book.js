  ...
  const CHAPTERS = [
    { id: "start", tab: "Start", icon: "★", colors: ["#ffe066", "#f0b400"], title: "Willkommen", pages: [
      `<div class="ribbon display">Willkommen</div>
       <p>Der Notentrainer übt eine Sache: <b>Noten sehen, die richtige Taste treffen</b>, immer flüssiger. Das Piano hängt per MIDI dran, jede Taste wird sofort geprüft.</p>
       ...
       <p>Dieses Handbuch erklärt jeden Modus und die Musik dahinter. Die Lesezeichen links führen zu den Kapiteln, die Pfeile unten blättern.</p>
      ...
      `<h3>Der Spielbildschirm</h3>
       ...
       <li><b>Multi</b>: ab 10 in Folge ×2, ab 20 ×3, ab 30 ×4. Jeder Treffer bringt 10 XP mal Multi.</li>
       <li><b>Treffer</b>: Quote der Runde. <b>XP</b>: was du gerade verdienst.</li>
      ...
      `<h3>XP und Level</h3>
       <p>XP sammeln sich über alle Runden. Level 2 ab 100 XP, Level 3 ab 283, Level 5 ab 800, Level 10 ab 2700. Im Abenteuer gibt es Bonus-XP je Stern.</p>
       ...
       <li><b>Aufwärmen</b>: drei Runden hintereinander: Tonleiter, ein Lauf um die schwache Stelle, Phrasen.</li></ul>
       <h3>Statistik</h3>
    ...
    { id: "noten", tab: "Noten", icon: "𝄞", colors: ["#5ee2ff", "#0ea5c9"], title: "Noten lesen", pages: [
      `<div class="ribbon display">Das Notensystem</div>
       ...
       <p>Der <b>Violinschlüssel</b> (G-Schlüssel) kringelt sich um die zweite Linie von unten: das ist <b>G4</b>. Linien von unten: E G H D F, Merkhilfe „Es Geht Hurtig Durch Fleiß“. Zwischenräume: F A C E.</p>`,
      `<h3>Der Bassschlüssel</h3>
       <p>Die beiden Punkte umschließen die vierte Linie von unten: das ist <b>F3</b>. Linien: G H D F A, Zwischenräume: A C E G. Die linke Hand liest meist hier.</p>
      ...
      `<h3>Hilfslinien</h3>
       <p>Über und unter dem System geht es mit kurzen Strichen weiter. <b>C4</b> liegt genau zwischen beiden Schlüsseln: eine Hilfslinie unter dem Violinschlüssel, eine über dem Bassschlüssel. Darum heißt es das mittlere C.</p>
       ${fig("ledger", 170, "Hilfslinien unter und über dem Violinschlüssel.")}`,
      `<h3>Namen und Oktaven</h3>
    ...
    { id: "rhythmus", tab: "Rhythmus", icon: "♩", colors: ["#f9a8d4", "#be185d"], title: "Notenwerte und Rhythmus", pages: [
      `<div class="ribbon display">Notenwerte</div>
       <p>Die Form der Note sagt, wie lang sie klingt. Gezählt wird in <b>Schlägen</b>: im Viervierteltakt ist eine Viertel ein Schlag.</p>
      ...
      `<h3>Takt und Taktart</h3>
       ...
       <p>Senkrechte <b>Taktstriche</b> teilen die Musik in Takte. Die <b>Taktart</b> am Anfang sagt, wie viele Schläge ein Takt hat: <b>4/4</b> vier Viertel („1 2 3 4“), <b>3/4</b> drei (Walzer, Menuett), <b>2/4</b> zwei. Die Eins ist der betonte Schlag.</p>`,
      `<h3>Tempo</h3>
    ...
    { id: "vorzeichen", tab: "Vorzeichen", icon: "♯", colors: ["#ffe066", "#d97706"], title: "Vorzeichen und Tonarten", pages: [
      `<div class="ribbon display">Vorzeichen</div>
       <p>Ein <b>Kreuz</b> ♯ vor der Note macht sie einen Halbton höher: die schwarze Taste rechts daneben. Ein <b>B</b> ♭ macht sie einen Halbton tiefer: die schwarze Taste links. Das <b>Auflösungszeichen</b> ♮ hebt beides wieder auf.</p>
      ...
      `<h3>Die schwarzen Tasten</h3>
       ...
       <p>Dieselbe schwarze Taste hat zwei Namen: Fis und Ges sind dieselbe Taste, der Name richtet sich nach der Tonart.</p>
      ...
      `<h3>Vorzeichnung: die Tonart</h3>
       <p>Kreuze oder Bs direkt hinter dem Schlüssel gelten für das <b>ganze Stück</b> und in allen Oktaven. G-Dur hat ein Kreuz auf der F-Linie: jedes F wird zum Fis, ohne dass etwas vor der Note steht.</p>
      ...
      `<h3>Dur und Moll</h3>
       ...
       <p><b>Dur</b> klingt hell, <b>Moll</b> dunkler. Jede Vorzeichnung gehört zu einer Dur- und einer Moll-Tonart (parallele Tonarten, der Moll-Grundton liegt drei Halbtöne tiefer). Welche gemeint ist, hört man am Schluss: er endet meist auf dem Grundton.</p>
       <p>Der <b>Quintenzirkel</b>: mit jedem Kreuz mehr liegt der Grundton eine Quinte höher (C, G, D, A, E, H), mit jedem B eine Quinte tiefer (C, F, B, Es, As).</p>
    ...
    { id: "modi", tab: "Üben", icon: "▶", colors: ["#ffa25e", "#e8621c"], title: "Einzeln, Lauf, Blindflug", pages: [
      `<div class="ribbon display">Einzeln und Lauf</div>
       ...
       <p><b>Lauf</b>: Die Noten kommen von rechts und müssen an der roten Linie getroffen werden. Das Fenster ist <b>±150 ms</b>: rechts der Linie ist zu früh, links zu spät. Wer gar nicht spielt, sieht die Note rot werden.</p>
    ...
    { id: "stuecke", tab: "Stücke", icon: "♫", colors: ["#ffe066", "#f0b400"], title: "Stücke und beide Hände", pages: [
      `<div class="ribbon display">Stücke</div>
       <p>In der <b>Bibliothek</b> liegen vier Starter-Stücke, eigene lassen sich importieren. Der Modus <b>Stücke</b> zieht <b>Phrasen</b> daraus, ein bis zwei Takte, an Taktgrenzen geschnitten, gewichtet nach dem, was zuletzt schwerfiel. Der Titel steht unter dem System, der Taktstrich davor.</p>
    ...
    { id: "abenteuer", tab: "Abenteuer", icon: "⚑", colors: ["#ff7cc0", "#e0338a"], title: "Das Abenteuer", pages: [
      `<div class="ribbon display">Das Abenteuer</div>
       ...
       <ul><li><b>Sterne</b>: 1 ab 60 % Quote, 2 ab 80 %, 3 ab 95 %. Bosse verlangen 70, 85 und 97 %.</li>
    ...
    { id: "technik", tab: "Technik", icon: "⚙", colors: ["#86b8ff", "#2563eb"], title: "Piano und MIDI", pages: [
      `<div class="ribbon display">Verbindung</div>
       ...
       <ul><li>Das Interface (mioXC) hat zwei Stecker: <b>IN</b> an die Buchse <b>MIDI OUT</b> des Pianos (lesen), <b>OUT</b> an <b>MIDI IN</b> (abspielen). Die Beschriftung ist aus Sicht des Interfaces.</li>
       <li>Die USB-Buchse des Pianos braucht einen Treiber und geht am iPad und Handy nicht.</li>
       <li>Am <b>iPad</b> läuft die Seite in der App „MIDIWeb Browser“, weil Safari kein Web MIDI kennt. Am Android-Handy in Chrome.</li></ul>
